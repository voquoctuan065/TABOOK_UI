...
function UpdateBook({ selectedBookId, handleUpdateClose, handleAddBookSuccess }) {
    ...
    useEffect(() => {
        if (bookById) {
            ...
            setYearProduce(bookById.yearProduce || '');
            setStockQuantity(bookById.stockQuantity || '');
            setDiscountedPrice(bookById.discountedPrice || '');
            setDiscountPercent(bookById.discountPercent || '');
    ...
    return (
        <div>
            <h5 className="font-bold text-2xl text-center text-red-700">Cập nhật sách</h5>
            <Grid container>
                <Grid item xs={9}>
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <Grid container spacing={3} sx={{ width: '100%' }}>
                            <Grid item xs={6}>
                                <TextField
                                    ...
                                    variant={bookTitle ? 'outlined' : 'filled'}
                                />
                            </Grid>
                            <Grid item xs={6}>
                                <TextField
                                    ...
                                    variant={bookPrice ? 'outlined' : 'filled'}
                                />
                            </Grid>
                            <Grid item xs={6}>
                                <TextField
                                    ...
                                    variant={discountPercent ? 'outlined' : 'filled'}
                                />
                            </Grid>
                            <Grid item xs={6}>
                                <TextField
                            ...
                            <Grid item xs={6}>
                                <TextField
                                    ...
                                    variant={stockQuantity ? 'outlined' : 'filled'}
                                />
                            </Grid>
                            <Grid item xs={6}>
                                <TextField
                                    ...
                                    variant={yearProduce ? 'outlined' : 'filled'}
                                />
                            </Grid>
                            <Grid item xs={6}>
                                <TextField
                                    ...
                                    variant={authorName ? 'outlined' : 'filled'}
                                />
                            </Grid>
                            ...
                            <Grid item xs={12}>
                                ...
                                <ReactQuill theme="snow" value={bookDescription} onChange={setBookDescription} />
                            </Grid>
                        ...
                        <Dialog open={successDialogOpen} onClose={handleAddSuccessClose}>
                            ...
                            <DialogContent>
                                <p>Sách đã được cập nhật thành công.</p>
                            </DialogContent>
                            <DialogActions>
