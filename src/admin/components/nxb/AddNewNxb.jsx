...
function AddNewNxb({ handleClose, handleAddNXBSuccess }) {
    ...
    return (
        <div>
            <form className="space-y-6" onSubmit={handleSubmit}>
                <h5 className="font-bold text-2xl text-center text-red-700">Thêm nhà xuất bản mới</h5>
