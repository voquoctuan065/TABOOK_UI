...
import { men_kurta } from '../men_kurta';
        ...
        <div className="bg-white">
            <div className="pt-6">
                ...
                <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-5 pt-10">
                    ...
                    {/* Product info */}
                    <div
                        className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-2-7xl lg:px-8
                    lg:pb-24
                    "
                    >
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className="mt-6 flex space-x-5 items-center text-lg lg:text-xl text-gray-900">
